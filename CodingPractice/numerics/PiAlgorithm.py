...
start_time = time.time() #it provides the current time
...
print(calculate_pi(numberofdigits))
print(Fore.RED + "\nTime taken:", time.time()-start_time)  #subtracting the current time.time() with the one at the begining of the code